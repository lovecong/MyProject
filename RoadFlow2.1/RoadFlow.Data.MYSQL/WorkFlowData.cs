    ...
    public class WorkFlowData : RoadFlow.Data.Interface.IWorkFlowData
    {
        ...
        public int Add(RoadFlow.Data.Model.WorkFlowData model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				new MySqlParameter("@TableName", MySqlDbType.String, 500){ Value = model.TableName },
				new MySqlParameter("@FieldName", MySqlDbType.String, 500){ Value = model.FieldName },
				new MySqlParameter("@Value", MySqlDbType.String, 8000){ Value = model.Value }
			};
