    ...
    public class Organize : RoadFlow.Data.Interface.IOrganize
    {
        ...
        public int Add(RoadFlow.Data.Model.Organize model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				new MySqlParameter("@Name", MySqlDbType.String, 2000){ Value = model.Name },
				new MySqlParameter("@Number", MySqlDbType.String, 900){ Value = model.Number },
				...
				model.ChargeLeader == null ? new MySqlParameter("@ChargeLeader", MySqlDbType.String, 200) { Value = DBNull.Value } : new MySqlParameter("@ChargeLeader", MySqlDbType.String, 200) { Value = model.ChargeLeader },
				model.Leader == null ? new MySqlParameter("@Leader", MySqlDbType.String, 200) { Value = DBNull.Value } : new MySqlParameter("@Leader", MySqlDbType.String, 200) { Value = model.Leader },
        ...
        {
            string sql = "SELECT GetMaxSort(MAX(Sort),0)+1 FROM Organize WHERE ParentID=@ParentID";
            MySqlParameter[] parameters = new MySqlParameter[]{
				new MySqlParameter("@ParentID", MySqlDbType.VarChar){ Value = id }
			};
