    ...
    public class WorkFlowArchives : RoadFlow.Data.Interface.IWorkFlowArchives
    {
        ...
        public int Add(RoadFlow.Data.Model.WorkFlowArchives model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				new MySqlParameter("@FlowName", MySqlDbType.String, 1000){ Value = model.FlowName },
				...
				new MySqlParameter("@InstanceID", MySqlDbType.String, 500){ Value = model.InstanceID },
				new MySqlParameter("@Title", MySqlDbType.String, 8000){ Value = model.Title },
