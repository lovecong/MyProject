    ...
    public class Dictionary : RoadFlow.Data.Interface.IDictionary
    {
        ...
        public int Add(RoadFlow.Data.Model.Dictionary model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				model.Code == null ? new MySqlParameter("@Code", MySqlDbType.String, 500) { Value = DBNull.Value } : new MySqlParameter("@Code", MySqlDbType.String, 500) { Value = model.Code },
				model.Value == null ? new MySqlParameter("@Value", MySqlDbType.String, -1) { Value = DBNull.Value } : new MySqlParameter("@Value", MySqlDbType.String, -1) { Value = model.Value },
				...
				model.Other == null ? new MySqlParameter("@Other", MySqlDbType.String, -1) { Value = DBNull.Value } : new MySqlParameter("@Other", MySqlDbType.String, -1) { Value = model.Other },
        ...
        public List<RoadFlow.Data.Model.Dictionary> GetChilds(string code)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				new MySqlParameter("@Code", MySqlDbType.String){ Value = code }
			};
            MySqlDataReader dataReader = dbHelper.GetDataReader(sql, parameters);
            List<RoadFlow.Data.Model.Dictionary> List = DataReaderToList(dataReader);
            dataReader.Close();
