    ...
    public class WorkFlowTask : RoadFlow.Data.Interface.IWorkFlowTask
    {
        ...
        public int Add(RoadFlow.Data.Model.WorkFlowTask model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				new MySqlParameter("@StepName", MySqlDbType.String, 1000){ Value = model.StepName },
				new MySqlParameter("@InstanceID", MySqlDbType.String, 50){ Value = model.InstanceID },
				...
				new MySqlParameter("@Title", MySqlDbType.String, 4000){ Value = model.Title },
				new MySqlParameter("@SenderID", MySqlDbType.VarChar, -1){ Value = model.SenderID },
				new MySqlParameter("@SenderName", MySqlDbType.String, 100){ Value = model.SenderName },
				...
				new MySqlParameter("@ReceiveName", MySqlDbType.String, 100){ Value = model.ReceiveName },
				...
				model.Comment == null ? new MySqlParameter("@Comment", MySqlDbType.String, -1) { Value = DBNull.Value } : new MySqlParameter("@Comment", MySqlDbType.String, -1) { Value = model.Comment },
        ...
        public int Delete(Guid flowID, Guid groupID)
        {
            ...
            if (!flowID.IsEmptyGuid())
            {
                ...
                parameters.Add(new MySqlParameter("@FlowID", MySqlDbType.VarChar) { Value = flowID });
            }
        ...
        public List<RoadFlow.Data.Model.WorkFlowTask> GetTasks(Guid userID, out string pager, string query="", string title="", string flowid="", string sender="", string date1="", string date2="", int type=0)
        {
            ...
            if (!title.IsNullOrEmpty())
            {
                ...
                parList.Add(new MySqlParameter("@Title", MySqlDbType.String, 2000) { Value = title });
            }
            if (flowid.IsGuid())
            {
            ...
            if (date2.IsDateTime())
            {
                ...
                parList.Add(new MySqlParameter("@ReceiveTime1", MySqlDbType.DateTime) { Value = date2.ToDateTime().AddDays(1).Date });
            }
        ...
        public List<RoadFlow.Data.Model.WorkFlowTask> GetInstances(Guid[] flowID, Guid[] senderID, Guid[] receiveID, out string pager, string query = "", string title = "", string flowid = "", string date1 = "", string date2 = "", int status = 0)
        {
            ...
            StringBuilder sql = new StringBuilder(@"SELECT a.*,ROW_NUMBER() OVER(ORDER BY a.SenderTime DESC) AS PagerAutoRowNumber FROM WorkFlowTask a
                WHERE a.ID=(SELECT  ID FROM WorkFlowTask WHERE FlowID=a.FlowID AND GroupID=a.GroupID ORDER BY Sort DESC) LIMIT 1");
        ...
        public int Completed(Guid taskID, string comment = "", bool isSign = false, int status = 2, string note="")
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				comment.IsNullOrEmpty() ? new MySqlParameter("@Comment", MySqlDbType.String){ Value = DBNull.Value } : new MySqlParameter("@Comment", MySqlDbType.String){ Value = comment },
                new MySqlParameter("@CompletedTime1", MySqlDbType.DateTime){ Value = RoadFlow.Utility.DateTimeNew.Now },
                new MySqlParameter("@IsSign", MySqlDbType.Int32){ Value = isSign?1:0 },
                new MySqlParameter("@Status", MySqlDbType.Int32){ Value = status },
                note.IsNullOrEmpty()?new MySqlParameter("@Note", MySqlDbType.String){ Value = DBNull.Value }:new MySqlParameter("@Note", MySqlDbType.String){ Value = note },
        ...
        public List<RoadFlow.Data.Model.WorkFlowTask> GetTaskList(Guid taskID, bool isStepID = true)
        {
            ...
            MySqlParameter[] parameters1 = new MySqlParameter[]{
                ...
                new MySqlParameter("@StepID", MySqlDbType.VarChar){ Value = isStepID ? task.StepID : task.PrevStepID }
			};
        ...
        {
            string sql = "SELECT  ID FROM WorkFlowTask WHERE FlowID=@FlowID LIMIT 1";
            MySqlParameter[] parameters = new MySqlParameter[]{
                new MySqlParameter("@FlowID", MySqlDbType.VarChar){ Value = flowID }
			};
            MySqlDataReader dataReader = dbHelper.GetDataReader(sql, parameters);
        ...
        {
            string sql = "SELECT  ID FROM WorkFlowTask WHERE FlowID=@FlowID AND StepID=@StepID AND GroupID=@GroupID AND ReceiveID=@ReceiveID AND Status IN(-1,0,1) LIMIT 1";
            MySqlParameter[] parameters = new MySqlParameter[]{
                new MySqlParameter("@FlowID", MySqlDbType.VarChar){ Value = flowID },
                new MySqlParameter("@StepID", MySqlDbType.VarChar){ Value = stepID },
                new MySqlParameter("@GroupID", MySqlDbType.VarChar){ Value = groupID },
        ...
        public int UpdateTempTasks(Guid flowID, Guid stepID, Guid groupID, DateTime? completedTime, DateTime receiveTime)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
                !completedTime.HasValue ? new MySqlParameter("@CompletedTime", MySqlDbType.DateTime) { Value = DBNull.Value } : 
                new MySqlParameter("@CompletedTime", MySqlDbType.DateTime) { Value = completedTime.Value },
                new MySqlParameter("@ReceiveTime", MySqlDbType.DateTime){ Value = receiveTime },
                new MySqlParameter("@SenderTime", MySqlDbType.DateTime){ Value = receiveTime },
                new MySqlParameter("@FlowID", MySqlDbType.VarChar){ Value = flowID },
                new MySqlParameter("@StepID", MySqlDbType.VarChar){ Value = stepID },
                new MySqlParameter("@GroupID", MySqlDbType.VarChar){ Value = groupID }
			};
        ...
        public int DeleteTempTasks(Guid flowID, Guid stepID, Guid groupID, Guid prevStepID)
        {
            ...
            if (!prevStepID.IsEmptyGuid())
            {
                ...
                parameters.Add(new MySqlParameter("@PrevStepID", MySqlDbType.VarChar) { Value = prevStepID });
            }
            return dbHelper.Execute(sql, parameters.ToArray());
        }
