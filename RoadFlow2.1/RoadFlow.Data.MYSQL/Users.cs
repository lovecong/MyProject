    ...
    public class Users : RoadFlow.Data.Interface.IUsers
    {
        ...
        public int Add(RoadFlow.Data.Model.Users model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				new MySqlParameter("@Name", MySqlDbType.String, 100){ Value = model.Name },
				new MySqlParameter("@Account", MySqlDbType.String, 255){ Value = model.Account },
				new MySqlParameter("@Password", MySqlDbType.String, 500){ Value = model.Password },
        ...
        public RoadFlow.Data.Model.Users GetByAccount(string account)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				new MySqlParameter("@Account", MySqlDbType.String, 255){ Value = account }
			};
            MySqlDataReader dataReader = dbHelper.GetDataReader(sql, parameters);
            List<RoadFlow.Data.Model.Users> List = DataReaderToList(dataReader);
            dataReader.Close();
        ...
        public bool HasAccount(string account, string userID = "")
        {
            ...
            plist.Add(new MySqlParameter("@Account", MySqlDbType.String) { Value = account });
            if (userID.IsGuid())
            {
                sql += " and ID<>@ID";
