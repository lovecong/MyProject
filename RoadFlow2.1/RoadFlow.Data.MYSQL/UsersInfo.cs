    ...
    public class UsersInfo : RoadFlow.Data.Interface.IUsersInfo
    {
        ...
        public int Add(RoadFlow.Data.Model.UsersInfo model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				model.Officer == null ? new MySqlParameter("@Officer", MySqlDbType.String, 1000) { Value = DBNull.Value } : new MySqlParameter("@Officer", MySqlDbType.String, 1000) { Value = model.Officer },
				model.Tel == null ? new MySqlParameter("@Tel", MySqlDbType.String, 500) { Value = DBNull.Value } : new MySqlParameter("@Tel", MySqlDbType.String, 500) { Value = model.Tel },
				model.Fax == null ? new MySqlParameter("@Fax", MySqlDbType.String, 500) { Value = DBNull.Value } : new MySqlParameter("@Fax", MySqlDbType.String, 500) { Value = model.Fax },
				model.Address == null ? new MySqlParameter("@Address", MySqlDbType.String, 500) { Value = DBNull.Value } : new MySqlParameter("@Address", MySqlDbType.String, 500) { Value = model.Address },
				model.Email == null ? new MySqlParameter("@Email", MySqlDbType.String, 50) { Value = DBNull.Value } : new MySqlParameter("@Email", MySqlDbType.String, 50) { Value = model.Email },
				model.QQ == null ? new MySqlParameter("@QQ", MySqlDbType.String, 50) { Value = DBNull.Value } : new MySqlParameter("@QQ", MySqlDbType.String, 50) { Value = model.QQ },
				model.MSN == null ? new MySqlParameter("@MSN", MySqlDbType.String, 50) { Value = DBNull.Value } : new MySqlParameter("@MSN", MySqlDbType.String, 50) { Value = model.MSN },
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<RoadFlow.Data.Model.UsersInfo> DataReaderToList(MySqlDataReader dataReader)
        {
