    ...
    public class UsersApp : RoadFlow.Data.Interface.IUsersApp
    {
        ...
        public int Add(RoadFlow.Data.Model.UsersApp model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				model.Title == null ? new MySqlParameter("@Title", MySqlDbType.String, 400) { Value = DBNull.Value } : new MySqlParameter("@Title", MySqlDbType.String, 400) { Value = model.Title },
				model.Params == null ? new MySqlParameter("@Params", MySqlDbType.String, 500) { Value = DBNull.Value } : new MySqlParameter("@Params", MySqlDbType.String, 500) { Value = model.Params },
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<RoadFlow.Data.Model.UsersApp> DataReaderToList(MySqlDataReader dataReader)
        {
