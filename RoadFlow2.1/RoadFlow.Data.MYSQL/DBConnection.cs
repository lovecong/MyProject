    ...
    public class DBConnection : RoadFlow.Data.Interface.IDBConnection
    {
        ...
        public int Add(RoadFlow.Data.Model.DBConnection model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				new MySqlParameter("@Name", MySqlDbType.String, 500){ Value = model.Name },
				new MySqlParameter("@Type", MySqlDbType.String, 500){ Value = model.Type },
				new MySqlParameter("@ConnectionString", MySqlDbType.String, -1){ Value = model.ConnectionString },
